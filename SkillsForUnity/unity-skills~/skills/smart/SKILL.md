...
### smart_scene_query
Query objects by component property (params: componentName, propertyName, op, value). e.g. componentName='Light', propertyName='intensity', op='>', value='10'

| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `componentName` | string | Yes | - | Canonical signature parameter |
| `propertyName` | string | Yes | - | Canonical signature parameter |
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `layoutType` | string | No | "Linear" | Canonical signature parameter |
| `axis` | string | No | "X" | Canonical signature parameter |
| `spacing` | float | No | 2.0f | Canonical signature parameter |
| `columns` | int | No | 3 | Canonical signature parameter |
| `arcAngle` | float | No | 180f | Canonical signature parameter |
| `lookAtCenter` | bool | No | false | Canonical signature parameter |

### smart_reference_bind
Auto-fill a List/Array field with objects matching tag or name pattern

| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `targetName` | string | Yes | - | Canonical signature parameter |
| `componentName` | string | Yes | - | Canonical signature parameter |
| `fieldName` | string | Yes | - | Canonical signature parameter |
| `sourceTag` | string | No | null | Canonical signature parameter |
| `sourceName` | string | No | null | Canonical signature parameter |
| `appendMode` | bool | No | false | Canonical signature parameter |
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `maxDistance` | float | No | 100f | Canonical signature parameter |
| `alignRotation` | bool | No | false | Canonical signature parameter |
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `gridSize` | float | No | 1f | Canonical signature parameter |
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `posRange` | float | No | 0f | Canonical signature parameter |
| `rotRange` | float | No | 0f | Canonical signature parameter |
| `scaleMin` | float | No | 1f | Canonical signature parameter |
| `scaleMax` | float | No | 1f | Canonical signature parameter |
